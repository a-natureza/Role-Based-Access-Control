const Permission = require("../models/RoleBasedAccessControl/Permission")
const Role = require("../models/RoleBasedAccessControl/Role")
const PermissionRole = require("../models/RoleBasedAccessControl/PermissionRole")
const User = require("../models/RoleBasedAccessControl/User")
const UserRole = require("../models/RoleBasedAccessControl/UserRole")
...
class RbacController {
    ...
    async addPermissionToRole(req, res) {
        try {
            ...
            // 2ª forma
            // await roleExists.addPermission(permissionExists)
